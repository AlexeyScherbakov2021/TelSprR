    ...
    render() {
        ...
        return (
            ...
            <div className="container-fluid d-flex" ref={this.myRef} >
                <Otdel callBack={this.clickOtdel} currentOtdel={this.state.curOtdel} />
                <div className="col-12 offset-0 offset-md-3 col-md-9 offset-lg-4 col-lg-8">
                    <Alpha callBack={this.clickAlpha} currentAlpha={this.state.curAlpha} curOtdel={this.state.curOtdel} />
                    <Cards curAlpha={this.state.curAlpha} curOtdel={this.state.curOtdel} searchText={this.props.searchText} adminEdit={this.props.adminEdit} />
                </div>
